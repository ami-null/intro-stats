...
\begin{document}
	...
	\begin{frame}{Finding Probabilities Using Z-table}
		...
		\begin{itemize}
			\item Probability that a variable is less than a value: \(P(Z < z) = \Phi(z)\)
			\item Probability that a variable is greater than a value: \(P(Z > z) = 1- P(Z < z) = 1 - \Phi(z)\)
			\item Probability that a variable lies between two values: \(P(a < Z < b) = P(Z < b)- P(Z < a) = \Phi(b) - \Phi(a)\)
			\item Probability that a variable lies outside an interval: \(P(Z < a \cup Z>b) = P(Z < a) + 1 - P(Z < b) = \Phi(a) + 1 - \Phi(b)\)
