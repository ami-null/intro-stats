...
\begin{document}
    ...
    \begin{frame}{Example}
        ...
        \textbf{Variance}, $\sigma^2 = \frac{(7.5-6.9)^2 + (4.5-6.9)^2 + ... + (5.5-6.9)^2}{10-1}=\frac{30.28}{9}=3.36 \, \text{pound}^2$
        \vspace{0.5em}

        \textbf{Standard deviation (SD)}, $\sigma = \sqrt{3.36} = 1.83$ pound
        \vspace{0.5em}

        \textbf{Coefficient of Variation, CV} $= \frac{\sigma}{\bar{x}} = \frac{1.83}{6.9} = 0.2652$
    \end{frame}
