...
\begin{document}
    ...
    \begin{frame}{Symmetric Distribution}
        \begin{center}
            \includegraphics[width=0.65\textwidth]{plots/symmetric.pdf}
        \end{center}
    ...
    \begin{frame}{Left Skewed Distribution}
        \begin{center}
            \includegraphics[width=0.65\textwidth]{plots/left-skewed.pdf}
        \end{center}
    ...
    \begin{frame}{Right Skewed Distribution}
        \begin{center}
            \includegraphics[width=0.65\textwidth]{plots/right-skewed.pdf}
        \end{center}
