...
\begin{document}
    ...
    \begin{frame}{Variance}
        \begin{itemize}
            \item Variance is a measure of dispersion based on squared deviations from the mean
            \item It measures how far observations spread out from the mean, on average
