...
\begin{document}
	...
	\begin{frame}{Conditional Probability}
		...
		\begin{itemize}
			...
			\item it also shrinks the samples to $B$ only
		\end{itemize}
	...
	\begin{frame}{Multiplication Law of Probability}
		\begin{itemize}
			\item For two dependent events $A$ and $B$, the probability that, both events will occur simultaneously is:
			\[
				P(A \cap B) = P(A)\,P(B \mid A) = P(A \mid B) \, P(B)
			\]

			\item For two independent events, the probability of both occuring simultaneously is:
			\[
				P(A \cap B) = P(A)\,P(B)
			\]
		\end{itemize}
