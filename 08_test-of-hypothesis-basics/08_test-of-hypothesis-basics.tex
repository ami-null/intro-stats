...
\begin{document}
    ...
    \begin{frame}{Link with Sampling Distributions}
        \begin{itemize}
            \item Hypothesis testing relies on sampling distributions
            \item If $H_0$ is true, the test statistic follows a known distribution
            \item Example:
            \[
            Z = \frac{\bar{X} - \mu_0}{\sigma/\sqrt{n}} \sim N(0,1)
            \]
            \item This allows us to quantify "how unusual" a sample is
        \end{itemize}
    \end{frame}
    ...
    \begin{frame}{Test Statistic}
        \begin{itemize}
            \item A function of sample data used to test $H_0$
            \item Example (Z-test):
            \[
    ...
    \begin{frame}{Rejection Region and Critical Value}
        \begin{itemize}
            \item Define a region where $H_0$ is rejected
    ...
    \begin{frame}{Level of Significance}
        \begin{itemize}
            ...
            \item Smaller $\alpha$ means stricter evidence required
    ...
    \begin{frame}{General Testing Procedure}
        \begin{itemize}
            ...
            \item Determine rejection region
