...
pdf("sampling-dist-under-null.pdf", width = 6.5, height = 3.5)
...
pdf("unlikely-region-under-null.pdf")
plot(x, y, type = "l", lwd = 2,
     main = "Unlikely Values under H0",
     xlab = "Test Statistic (Z)", ylab = "Density")
...
# ---- alpha
pdf("two-tail-rejection-region.pdf")
alpha <- 0.05
z_crit <- qnorm(1 - alpha/2)

plot(x, y, type = "l", lwd = 2,
     main = "Rejection Regions (Two-tailed Test)",
     xlab = "Test Statistic (Z)", ylab = "Density")
...
pdf("right-tailed-rejection-region.pdf")
plot(x, y, type = "l", lwd = 2,
     main = "Rejection Region (Right-tailed Test)",
     xlab = "Test Statistic (Z)", ylab = "Density")
...
pdf("left-tailed-rejection-region.pdf")
plot(x, y, type = "l", lwd = 2,
     main = "Rejection Region (Right-tailed Test)",
     xlab = "Test Statistic (Z)", ylab = "Density")
...
pdf("observed-fail-to-reject.pdf")
plot(x, y, type = "l", lwd = 2,
     main = "Decision Rule with Observed Test Statistic",
     xlab = "Test Statistic (Z)", ylab = "Density")
