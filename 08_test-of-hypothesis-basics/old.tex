...
\begin{document}
    ...
    \begin{frame}{Rejection Region and \(\alpha\) in Two-tailed Tests}
        \centering
        \includegraphics[width=0.75\textwidth]{plots/two-tail.pdf}
    \end{frame}


    \begin{frame}{Rejection Region and \(\alpha\) in Left-tailed Tests}
        \centering
        \includegraphics[width=0.75\textwidth]{plots/left-tailed.pdf}
    \end{frame}


    \begin{frame}{Rejection Region and \(\alpha\) in Right-tailed Tests}
        \centering
        \includegraphics[width=0.75\textwidth]{plots/right-tailed.pdf}
    \end{frame}
    ...
    \begin{frame}{Power of a Test}
        \begin{itemize}
            ...
            \end{itemize}
            \item Conventionally, power $\geq 0.80$ is considered adequate
        \end{itemize}
    \end{frame}
    ...
    \begin{frame}{P-value}
        \begin{itemize}
            ...
            \item It quantifies how ``surprising'' the data are under $H_0$
    ...
    \begin{frame}{P-value: Tails and Computation}
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \quad $p = P(Z \geq Z_{\text{cal}})$
                \item Left-tailed ($H_A: \mu < \mu_0$):
                \quad $p = P(Z \leq Z_{\text{cal}})$
                \item Two-tailed ($H_A: \mu \neq \mu_0$):
                \quad $p = 2\,P(Z \geq |Z_{\text{cal}}|)$
            \end{itemize}
            \item \textbf{Example} (from earlier): $Z_{\text{cal}} = 1.34$,\;
                right-tailed test
            \[
                p = P(Z \geq 1.34) \approx 0.090
            \]
