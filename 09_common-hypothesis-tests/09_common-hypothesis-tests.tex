...
\title{Some Common Hypothesis Tests}
...
\begin{document}
    ...
    \begin{frame}{Test about a Single Mean --- Choosing the Test}
        ...
        \begin{itemize}
            ...
            \item The \(t\) distribution converges to the normal distribution when \(n\) is large. However, using the \(t\) test regardless of sample size, is more robust
        \end{itemize}
    \end{frame}
    ...
    \begin{frame}{Test about a Single Mean --- Solution ($Z$-test)}
        \begin{columns}
            \begin{column}{0.55\textwidth}
                ...
                \textbf{P-value:} \(p = 2\,P(Z \geqslant 5.27) \leqslant 0.001\)
    ...
    \begin{frame}{Test about Two Means --- Choosing the Test}
        \begin{center}
            ...
            \end{tabular}
        \end{center}
        The \(t\) distribution converges to the normal distribution when \(n\) is large. However, using the \(t\) test regardless of sample size, is more robust.
    \end{frame}
    ...
    \begin{frame}{One-Way ANOVA --- Solution}
        ...
        \)
        \(
            \text{SSD} = \frac{577^2}{7}+\frac{282^2}{5}+\frac{341^2}{4}+\frac{191^2}{3} - CT
            = 1022.98
        \)
        \(
