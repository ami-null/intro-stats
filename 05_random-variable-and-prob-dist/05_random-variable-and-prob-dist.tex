...
\begin{document}
	...
	\begin{frame}{Finding Probability from CDF}
		\begin{columns}
			\begin{column}{0.5\textwidth}
				For Continuous RV:
				\begin{itemize}
					\item \(P(X \leqslant a) = P(X < a) = F(a)\)
					\item \(P(X = a) = 0\)
					\item \(P(X \geqslant a) = P(X > a) = 1 - F(a)\)
					\item \(P(a < X < b) = P(a \leqslant X \leqslant b) = F(b) - F(a)\)
				\end{itemize}
	...
	\begin{frame}{Example: Finding Probability from CDF}
...
MCQ randomly (without knowing the correct answers)
	...
	\begin{frame}{Area under the Curve: Rule of Thumb}
	...
	\begin{frame}{Standard Normal Variable}
