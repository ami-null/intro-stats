...
\begin{document}
	...
	\begin{frame}{Cumulative Distribution Function (CDF)}
		...
		Here, summing/integrating from $-\infty$ means that the lower limit of the sum/integral is the lowest value in the domain of the random variable $X$.
	\end{frame}
	...
	\begin{frame}{Mathematical Expectation}
		...
		\begin{itemize}
			\item When $X$ is discrete: \(\mathrm{E}(X) = \displaystyle \sum_{x} x\cdot p(x)\)
			\item When continuous: \(\mathrm{E}(X) = \displaystyle \int_{x} x\cdot f(x) dx\)
